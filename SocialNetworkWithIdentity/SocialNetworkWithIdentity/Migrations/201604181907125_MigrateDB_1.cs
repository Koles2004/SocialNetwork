namespace SocialNetworkWithIdentity.Migrations
{
    ...
    public partial class MigrateDB_1 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Text = c.String(),
                        Date = c.DateTime(nullable: false),
                        StatusForMessage = c.Boolean(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Photos", "Sender_Id", "dbo.ApplicationUsers");
            ...
            DropIndex("dbo.Photos", new[] { "Sender_Id" });
